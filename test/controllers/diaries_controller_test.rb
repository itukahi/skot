...
class DiariesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create diary" do
    assert_difference('Diary.count') do
      post diaries_url, params: { diary: { contents: @diary.contents, time: @diary.time, title: @diary.title, user_id: @diary.user_id } }
    end
  ...
  test "should update diary" do
    patch diary_url(@diary), params: { diary: { contents: @diary.contents, time: @diary.time, title: @diary.title, user_id: @diary.user_id } }
